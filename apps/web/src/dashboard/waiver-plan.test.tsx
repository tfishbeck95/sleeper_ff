...
const row = (id: string, priority: number, drop = 'Bench A'): WaiverRecommendation => ({ id, priority, add: player(id), drop: player(drop), horizon: 'streamer', risk: 'low', need: 'bye-cover', score: 10, projectedPoints: 12, pointsExplanation: "12.0 points under your league's full-PPR scoring this week", contributions: [{ stat: 'rec_yd', amount: 80, rate: .1, points: 8 }, { stat: 'rec', amount: 4, rate: 1, points: 4 }], opportunity: { targets: 6.2, targetsPerRouteRun: .22, routeParticipation: .74, targetShare: .17, redZoneTargets: 1, receptionPoints: 4, receptionShare: .333, touchdownShare: 0, archetype: 'volume-driven', passCatchingBack: true, stability: .88, trend: 1.5, floorLift: .19, explanation: 'Volume-driven role.', receptionExplanation: '4 of 12 points come from receptions at 1 per catch.' }, starterGain: 12, benchGain: 8, starterComparison: null, weakestBench: player(drop), dropCost: 4, dropReason: 'Weakest bench', upcoming: [], playoffPoints: null, reasons: [], uncertainty: [], faab: { min: 5, max: 10, remaining: 15, urgency: 'high', explanation: 'High urgency. Rival bids unknown.' } });
const report = (): WaiverReport => ({ scoringSnapshotId: 'complete-live:2026-09-08T12:00:00Z:00000000', scoringLabel: 'full-PPR', forecastUpdatedAt: '2026-09-08T12:00:00Z', rejected: [], leagueId: '1234', rosterId: 1, week: 8, season: '2026', generatedAt: '2026-09-08T12:00:00Z', rosterSyncedAt: '2026-09-08T12:00:00Z', source: { name: 'Test forecasts', updatedAt: '2026-09-08T12:00:00Z' }, status: 'ready', warnings: [], rosteredCount: 10, eligibleCount: 3, evaluatedCount: 3, recommendations: [], submission: { supported: false, url: 'https://sleeper.com/leagues/1234', instruction: 'Submit claims manually in Sleeper. No claims have been submitted.' } });
