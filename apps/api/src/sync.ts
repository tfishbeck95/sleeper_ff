...
export const REFRESH_AFTER_MS = { league: 60 * 60_000, users: 6 * 60 * 60_000, rosters: 5 * 60_000, matchups: 2 * 60_000, transactions: 2 * 60_000, draftPicks: 5 * 60_000, players: 24 * 60 * 60_000 } as const;
